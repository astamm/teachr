...
**Note:** The [**olsrr**](https://olsrr.rsquaredacademy.com) package provides a set of tools for improved output from linear regression models, designed mainly for beginner/intermediate R users. The package includes:
