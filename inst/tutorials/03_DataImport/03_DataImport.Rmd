...
```{r ex-csv-setup}
dir.create("www")
download.file("https://raw.githubusercontent.com/astamm/teachr/master/inst/tutorials/03_DataImport/www/nobel.csv", "www/nobel.csv")
```
...
dir.create("www")
download.file("https://github.com/astamm/teachr/raw/master/inst/tutorials/03_DataImport/www/favourite-food.xlsx", "www/favourite-food.xlsx")
```
...
```{r sales-exo-setup}
dir.create("www")
download.file("https://github.com/astamm/teachr/raw/master/inst/tutorials/03_DataImport/www/sales.xlsx", "www/sales.xlsx")
```
