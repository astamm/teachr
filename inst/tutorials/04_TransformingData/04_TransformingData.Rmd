...
```{r exo1, exercise=TRUE, exercise.setup="prepare-ncbikecrash"}
ncbikecrash %>%
  dplyr::filter(
    county ____ "Durham", 
...
```{r exo2, exercise=TRUE, exercise.setup="prepare-ncbikecrash"}
...
```{r exo3, exercise=TRUE, exercise.setup="prepare-ncbikecrash"}
...
```{r fish-exercise-setup, include=FALSE}
fisheries <- readr::read_csv("www/fisheries.csv")
continents <- readr::read_csv("www/continents.csv")
fisheries <- fisheries %>%
...
```{r fisheries-mean, exercise=TRUE, exercise.setup="fish-exercise-setup"}
...
```{r fisheries-summary, exercise=TRUE, exercise.setup="fish-exercise-setup"}
fisheries %>%                  # start with the fisheries tibble
  ___(
...
```{r fisheries-summary-continent, exercise=TRUE, exercise.setup="fish-exercise-setup"}
fisheries %>%
...
```{r fisheries-summary-continent-sorted, exercise=TRUE, exercise.setup="fish-exercise-setup"}
fisheries %>%
  ___ %>%                      # ensure calculations are done per continent
  ___(
    mean_ac = ___,             # calculate mean aquaculture
