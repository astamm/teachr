...
```{r crash-ex-setup, include=FALSE}
ncbikecrash <- readr::read_csv("www/ncbikecrash.csv")
```
...
```{r exo1, exercise=TRUE, exercise.setup="crash-ex-setup"}
ncbikecrash %>%
  dplyr::filter(
    county ____ "Durham", 
...
```{r exo2, exercise=TRUE, exercise.setup="crash-ex-setup"}
...
```{r exo3, exercise=TRUE, exercise.setup="crash-ex-setup"}
